    ...
    <Form className="card">
      <div className="row">
        <div className="col-1 ml-auto">
           <a className="btn btn-trans" type="button" data-toggle="collapse" href="#projectSortForm" aria-expanded="false" aria-controls="mentorSortForm"><i className="fa fa-bars"></i></a>
        </div>
      </div>
      <div id="projectSortForm" className="collapse">
        <div className="row">
